    ...
    <section id="home" className="min-h-screen relative flex items-center">
      ...
      <div className="absolute inset-0">
        <div 
          ...
          style={{
            background: `linear-gradient(to bottom right, rgba(var(--primary-rgb), 0.05), transparent, rgba(var(--secondary-rgb), 0.05))`
          }}
        />
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            >
              ...
              <div className="text-xl md:text-2xl text-foreground/80">
            ...
            >
              <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                ...
                <p className="text-sm text-foreground/70">{t('hero.stats.experience')}</p>
              </div>
              <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                <h3 className="text-3xl font-bold gradient-text">50+</h3>
                <p className="text-sm text-foreground/70">{t('hero.stats.projects')}</p>
              </div>
              <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                <h3 className="text-3xl font-bold gradient-text">30+</h3>
                <p className="text-sm text-foreground/70">{t('hero.stats.clients')}</p>
              </div>
              <div className="glass-card p-4 rounded-xl hover:scale-105 transition-transform">
                <h3 className="text-3xl font-bold gradient-text">15+</h3>
                <p className="text-sm text-foreground/70">{t('hero.stats.technologies')}</p>
              </div>
            </motion.div>
            ...
            >
              <a 
                href="#contact" 
                className="group glass-effect bg-primary text-white px-8 py-4 rounded-xl font-medium transition-all duration-300 flex items-center hover:scale-105"
                style={{
              ...
              <a 
                href="#projects" 
                className="group glass-effect px-8 py-4 rounded-xl font-medium transition-all duration-300 flex items-center hover:scale-105"
                style={{
            ...
            >
              <a href="#" className="glass-card w-10 h-10 rounded-full flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-all duration-300 hover:scale-110">
          ...
          >
            <div className="relative">
              ...
              <div 
                ...
                style={{
                  background: `linear-gradient(to top right, rgba(var(--primary-rgb), 0.2), rgba(var(--secondary-rgb), 0.2), rgba(var(--primary-rgb), 0.2))`
                }}
              />
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-square glass-card">
                <div 
                  className="absolute inset-0"
                  style={{
                    background: `linear-gradient(to bottom, transparent, transparent, rgba(var(--background-rgb), 0.2))`
                  }}
                />
                <div 
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-32 w-32" style={{ color: `rgba(var(--primary-rgb), 0.2)` }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* Decorative Elements */}
              <div className="absolute -top-4 -right-4 w-24 h-24 glass-card rounded-xl p-4 flex items-center justify-center">
              ...
              <div className="absolute -bottom-4 -left-4 w-24 h-24 glass-card rounded-xl p-4 flex items-center justify-center">
